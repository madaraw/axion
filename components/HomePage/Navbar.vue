<template>
  <nav class="w-full grid grid-flow-col px-6 min-h-[72px] items-center bg-white">
    <div>
      <NuxtLink to="/">
        <div class="flex items-center text-[#DE483A]">
          <div class="mr-1">
            <svg height="28" width="28" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 30.143 30.143" xml:space="preserve" fill="#000000">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <g>
                  <path style="fill:#DE483A;"
          ...
          <p class="text-3xl font-semibold">Axion</p>
        </div>
      </NuxtLink>
    </div>
